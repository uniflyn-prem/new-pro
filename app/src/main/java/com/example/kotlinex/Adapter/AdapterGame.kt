...
class AdapterGame(private val list : List<Games>, val context : Context) : RecyclerView.Adapter<AdapterGame.MyViewHolder>() {


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.bingo_layout,parent,false)
